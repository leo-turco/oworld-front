    ...
    >
      <div className="h-full px-3 py-4 overflow-y-auto bg-base-200 border-r border-neutral-content/60 shadow-xl sidebar-scrollbar">
        ...
        <div className="mb-5 flex flex-col justify-center items-center">
          ...
          <h2 className="alien-font shadow-neon text-2xl text-white font-bold tracking-[0.5em] mt-2 text-center">
            OWORLD
          </h2>
        </div>
        {/* Fin LOGO ET TITRE */}
          ...
          <div className="flex items-center justify-between">
            ...
            <span
              ...
              className={`cursor-pointer transition-transform duration-300 ${
                isCountryOpen ? 'rotate-0' : '-rotate-180'
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="space-y-2 font-medium mt-10 mb-10">
          <div className="flex items-center justify-between">
            ...
            <span
              onClick={() => setIsSolarSystemOpen(!isSolarSystemOpen)}
              className={`cursor-pointer transition-transform duration-300 ${
                isSolarSystemOpen ? 'rotate-0' : '-rotate-180'
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            className={`transition-all duration-300 overflow-hidden ${
              isSolarSystemOpen ? 'max-h-screen' : 'max-h-0'
            }`}
          >
                ...
                >
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M20.893 13.393l-1.135-1.135a2.252 2.252 0 01-.421-.585l-1.08-2.16a.414.414 0 00-.663-.107.827.827 0 01-.812.21l-1.273-.363a.89.89 0 00-.738 1.595l.587.39c.59.395.674 1.23.172 1.732l-.2.2c-.212.212-.33.498-.33.796v.41c0 .409-.11.809-.320 1.158l-1.315 2.191a2.11 2.11 0 01-1.81 1.025 1.055 1.055 0 01-1.055-1.055v-1.172c0-.92-.56-1.747-1.414-2.089l-.655-.261a2.25 2.25 0 01-1.383-2.46l.007-.042a2.25 2.25 0 01.29-.787l.09-.15a2.25 2.25 0 012.37-1.048l1.178.236a1.125 1.125 0 001.302-.795l.208-.73a1.125 1.125 0 00-.578-1.315l-.665-.332-.091.091a2.25 2.25 0 01-1.591.659h-.18c-.249 0-.487.1-.662.274a.931.931 0 01-1.458-1.137l1.411-2.353a2.25 2.25 0 00.286-.76m11.928 9.869A9 9 0 008.965 3.525m11.928 9.868A9 9 0 118.965 3.525"
                    />
                  </svg>
                  Mercury
                </Link>
