...
const CardProfil: React.FC<CardProfilProps> = ({
  id,
  imgUrl,
  gitUrl,
  activeImgUrl,
  ...
  <motion.div
    ...
    className={`relative ${
      active === id.toString()
        ? 'lg:flex-[3.5] flex-[10]'
        : 'lg:flex-[0.5] flex-[2]'
    } flex items-center justify-center min-w-[200px] h-[600px] transition-[flex] duration-[0.7s] ease-out-flex cursor-pointer`}
  ...
  >
    ...
    {active !== id.toString() ? (
      ...
      <div className="absolute bottom-0 p-8 flex justify-start w-full flex-col bg-[rgba(0,0,0,0.8)] rounded-b-[24px]">
        <div className="flex items-center w-[60px] h-[30px] rounded-[24px] glassmorphism mb-[16px]">
          <a
            href={gitUrl}
            target="_blank"
